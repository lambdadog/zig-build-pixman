# Pixman built with Zig

This project builds [Pixman](https://gitlab.freedesktop.org/pixman/pixman.git)
...
.{
    ...
    .dependencies = .{
        .pixman = .{
            .url = "https://github.com/mitchellh/zig-build-pixman/archive/<git-ref-here>.tar.gz",
...
```zig
const pixman = b.dependency("pixman", .{ .target = target, .optimize = optimize });
exe.linkLibrary(pixman.artifact("pixman"));
```
